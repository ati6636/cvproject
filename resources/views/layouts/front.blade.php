...
<header>
    ...
    <nav class="collapsible-nav" id="collapsible-nav">
        <a href="{{asset('front/index.html')}}" class="nav-link active">HOME</a>
        <a href="{{asset('front/resume.html')}}" class="nav-link">RESUME</a>
        <a href="{{asset('front/portfolio.html')}}" class="nav-link">PORTFOLIO</a>
        <a href="{{asset('front/blog.html')}}" class="nav-link">BLOG</a>
        <a href="{{asset('front/contact.html')}}" class="nav-link">CONTACT</a>
    </nav>
